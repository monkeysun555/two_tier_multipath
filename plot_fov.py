...
IS_SAVING = 1
def main():
	mat_contents_1 = sio.loadmat('Video_9_alpha_beta_new.mat')
	mat_contents_2 = sio.loadmat('Video_13_alpha_beta_new.mat')
	...
	raw_input()
	if IS_SAVING:
		h.savefig('fov_1.eps', format='eps', dpi=1000, figsize=(30, 10))
		i.savefig('fov_2.eps', format='eps', dpi=1000, figsize=(30, 10))
