...
# REGULAR_CHANNEL_TRACE = './new_traces/cooked_test_5G_traces/5Gnorway_train_17'
...
def main():
	...
	# init_video_rate, optimal_buffer_length, alpha_idx, gamma_idx = uti.load_init_rates(average_bw, REGULAR_CHANNEL_TRACE, VIEWPORT_TRACE_FILENAME_NEW, CODING_TYPE, False, Q_REF_EL)	# For test alpha curve
