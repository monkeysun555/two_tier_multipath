...
def load_5G_Data(fname, video_length, multiple=1, addition=0):
	...
	return content[:2*video_length+1], new_content
...
def main(fnames):
	for fname in fnames:
		...
		if fname == './traces/bandwidth/BW_Trace_5G_2.txt':
			...
			half_sec_network_trace, network_trace = load_5G_Data(fname, 900, 1.7, -520)
		else:
